...
/// Represents the definition an error to raise, following RFC 7807 (Problem Details)
...
pub struct ErrorDefinition {
    ...
    /// Gets/sets a short, human-readable summary of the error type.
    /// It SHOULD NOT change from occurrence to occurrence of the error, except for purposes of localization.
    /// Can be a runtime expression (${...}) or a literal string.
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub title: Option<String>,

    /// Gets/sets the status code generated by the origin for this occurrence of the error (RFC 7807).
    /// Must be an integer.
    pub status: i32,
    ...
    /// Can be a JSON Pointer or a runtime expression.
    #[serde(skip_serializing_if = "Option::is_none")]
...
macro_rules! define_error_type {
    ($factory:ident, $is:ident, $const:ident, $title:literal, $status:expr) => {
        ...
        pub fn $factory(detail: Option<String>, instance: Option<String>) -> Self {
            Self::new(ErrorTypes::$const, $title, $status, detail, instance)
        }
