...
pub fn validate_asyncapi_protocol(protocol: &str, prefix: &str, result: &mut ValidationResult) {
    validate_enum_value(protocol, AsyncApiProtocol::ALL_VALUES, "protocol", prefix, true, false, result);
}

/// Validates an HTTP call output format value
pub fn validate_http_output(output: &str, prefix: &str, result: &mut ValidationResult) {
    validate_enum_value(output, HttpOutputFormat::ALL_VALUES, "output", prefix, true, false, result);
}
...
pub fn validate_pull_policy(pull_policy: &str, prefix: &str, result: &mut ValidationResult) {
    validate_enum_value(pull_policy, PullPolicy::ALL_VALUES, "pullPolicy", prefix, false, false, result);
}
...
pub fn validate_container_cleanup(cleanup: &str, prefix: &str, result: &mut ValidationResult) {
    validate_enum_value(cleanup, ContainerCleanupPolicy::ALL_VALUES, "lifetime.cleanup", prefix, false, false, result);
}

/// Validates a script's language value
pub fn validate_script_language(language: &str, prefix: &str, result: &mut ValidationResult) {
    validate_enum_value(language, ScriptLanguage::ALL_VALUES, "language", prefix, false, false, result);
}
...
pub fn validate_oauth2_client_auth_method(
    ...
    validate_enum_value(method, OAuth2ClientAuthenticationMethod::ALL_VALUES, "client.authentication", prefix, true, false, result);
}
...
pub fn validate_oauth2_request_encoding(
    ...
    validate_enum_value(encoding, OAuth2RequestEncoding::ALL_VALUES, "request.encoding", prefix, true, false, result);
}

/// Validates an OAuth2 grant type value
pub fn validate_oauth2_grant_type(grant: &str, prefix: &str, result: &mut ValidationResult) {
    validate_enum_value(grant, OAuth2GrantType::ALL_VALUES, "grant", prefix, true, false, result);
}
...
pub fn validate_extension_task_type(extend: &str, prefix: &str, result: &mut ValidationResult) {
    validate_enum_value(extend, ExtensionTarget::ALL_VALUES, "extend", prefix, false, false, result);
}
...
pub fn validate_http_method(method: &str, prefix: &str, result: &mut ValidationResult) {
    validate_enum_value(method, HttpMethod::ALL_VALUES, "with.method", prefix, false, true, result);
}
